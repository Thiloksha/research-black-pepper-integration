          ...
          {isLarge ? (
            <View style={styles.desktopWrap}>
              <Animated.View style={[styles.leftPanel, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
                ...
                <Text style={styles.brandTagline}>Smart crop intelligence{'\n'}for black pepper farmers</Text>
...
function SignInForm({ navigation, isSmall }) {
  ...
  return (
    <View>
      ...
      <TouchableOpacity style={[styles.signInBtn, shadowBtn]} onPress={handleSignIn} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  desktopWrap: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', maxWidth: 920 },
  leftPanel: { flex: 1, maxWidth: 360, alignItems: 'flex-start', paddingRight: 48, paddingVertical: 20 },
  dividerVertical: { width: 1, height: 480, backgroundColor: '#d0e8d8', marginRight: 48, opacity: 0.7 },

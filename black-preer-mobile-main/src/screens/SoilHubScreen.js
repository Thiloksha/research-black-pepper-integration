...
const MENU_ITEMS = [
  {
    ...
    subtitle: 'Track live temperature, humidity, rainfall & UV index to protect your farm.',
    icon: 'partly-sunny-outline',
    accent: '#1565c0',
    lightAccent: '#e3f2fd',
    borderAccent: '#90caf9',
    badge: 'Live Weather',
    navigate: 'WeatherMonitor',
  },
  {
    title: 'Soil Monitor',
    subtitle: 'Monitor nitrogen, phosphorus, potassium, pH & moisture in real-time.',
    icon: 'flask-outline',
    accent: '#2e7d32',
    lightAccent: '#e8f5e9',
    borderAccent: '#a5d6a7',
    badge: 'IoT Sensors',
    navigate: 'SoilMonitor',
  },
  {
    title: 'Fertilizer Advisor',
    subtitle: 'Get precise fertilizer recommendations powered by ensemble ML models.',
    icon: 'leaf-outline',
    accent: '#e65100',
    lightAccent: '#fff3e0',
    borderAccent: '#ffcc80',
    badge: 'AI Powered',
    navigate: 'FertilizerAdvisor',
  },
  {
    title: 'Regional Dashboard',
    subtitle: 'View regional soil health maps and farm-wide comparative analytics.',
    icon: 'grid-outline',
    accent: '#6a1b9a',
    lightAccent: '#f3e5f5',
    borderAccent: '#ce93d8',
          ...
          >
            ...
            >
              ...
              <View style={styles.moduleBadge}>
                <Ionicons name="flask" size={13} color="#2d7a4f" />
                <Text style={styles.moduleBadgeText}>Soil Module</Text>
              </View>
              ...
              <Animated.View style={[styles.heroIconCircle, iconShadow, { transform: [{ scale: logoScale }] }]}>
                ...
                >
                  <Ionicons name="analytics" size={36} color="#2d7a4f" />
                </LinearGradient>
              </Animated.View>
              ...
              <Text style={[
                ...
                Soil{'\n'}
                <Text style={styles.heroTitleAccent}>Intelligence Hub</Text>
              </Text>
              ...
              <Text style={[
                ...
                Monitor environmental data, analyze live N-P-K soil metrics via IoT,
                and generate AI-backed fertilizer recommendations.
              </Text>
            ...
            <Animated.View style={[styles.footer, { opacity: heroAnim }]}>
              ...
              <Text style={styles.footerText}>
                Designed to support precise soil health tracking and fertilizer optimization.
              </Text>
            </Animated.View>
          </ScrollView>
        </SafeAreaView>
